...
import { fetUserAsync, selectLoggedIn } from '../authSlice'
        ...
        <Navbar>
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit(data => dispatch(fetUserAsync({email:data.email,password:data.password})))}>
                        <div>
