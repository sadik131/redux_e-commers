    ...
    <>
      <div className="bg-white">
        <div>
          ...
          <ProductGrid filters={NavFilter} handelSort={handelSort} handelChecked={handelChecked} products={products.products} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen}></ProductGrid>
